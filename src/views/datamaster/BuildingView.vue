    ...
    <div class="w-full space-y-4">
      ...
      <div class="flex">
        <div class="flex-1">
          <input
            type="text"
            class="form-input p-2 px-6 rounded-full bg-green-200 text-emerald-950 dark:text-green-200 dark:bg-emerald-950 shadow-2xl outline-1 dark:focus:outline-green-200 focus:outline-emerald-950"
      ...
      <!-- Table Component -->
      <div
        class="max-w-[480px] max-h-[450px] sm:max-w-full sm:max-h-[550px] overflow-auto rounded-md border border-green-200"
      >
        <table class="overflow-auto w-full table-auto text-sm">
          <thead
          ...
          <tbody>
            ...
            >
              <td class="text-left p-2">
                <button
                  class="rounded-full bg-yellow-400 px-2 flex text-white outline-1 outline-yellow-200 transition-all duration-300 hover:scale-105 shadow-2xl hover:cursor-pointer"
                >
                  <PencilIcon class="h-5 w-5" /> <span>Edit</span>
                </button>
              </td>
